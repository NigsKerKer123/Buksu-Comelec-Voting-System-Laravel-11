...
<div id="edit-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form id="edit-party-form" class="p-4 md:p-5" method="POST">
                @csrf
                @method('PUT')
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" id="edit-description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write new description here"></textarea>                    
                    </div>
                </div>
...
<div id="delete-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <form id="delete-party-form" class="p-4 md:p-5" method="POST">
                @csrf
                @method('DELETE')
                <p class="mb-4 text-sm text-gray-500 dark:text-gray-300">Are you sure you want to delete the party <span id="delete-party-name" class="font-bold"></span>?</p>
...
function openEditModal(id, name, description) {
    ...
    document.getElementById('edit-party-form').action = '/admin/party/' + id;
}

function openDeleteModal(id, name) {
    document.getElementById('delete-party-name').textContent = name;
    document.getElementById('delete-party-form').action = '/admin/party/' + id;
}
</script>